...
cp 99runinstallscript /home/pi/deepak/enhanced_dashboard_system/99runinstallscript
cp setup_boot.sh /home/pi/deepak/enhanced_dashboard_system/setup_boot.sh
