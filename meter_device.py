    ...
    def read_data(self):
        ...
        if self.simulation_mode:
            ...
            if mode == 'phase_loss':
                ...
                a_r = random.uniform(21, 25.5)  # 50% tighter upper bound
            elif mode == 'bad_pf':
                pf_r = pf_y = pf_b = random.uniform(0.6, 0.65)  # 50% tighter
            elif mode == 'overvoltage':
                v_b = random.uniform(265, 267.5)  # 50% tighter
            elif mode == 'reverse_power':
                pf_r = pf_y = pf_b = -random.uniform(0.95, 1.0)  # 50% tighter
            elif mode == 'freq_drift':
                freq = random.choice([random.uniform(48.25, 48.75), random.uniform(51.75, 52.25)])  # 50% tighter
            # Debug print removed
