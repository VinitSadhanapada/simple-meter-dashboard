...
SCRIPT_DIR="/home/$USER/Desktop/MFM_offline_setup"
PYTHON="$(which python3)"
DASHBOARD="$SCRIPT_DIR/offline_rpi_dashboard.py"
...
{
    cat /tmp/cron_tmp_$$
    echo "@reboot $PYTHON $DASHBOARD --run > $SCRIPT_DIR/dashboard.log 2>&1 &"
